...
import { instances, statements, expTheses, expThesesTranslation, expAppTheses, statementTranslations, elections, notifications, genders, candidatesLight, parties, partyVotes, candidateVotes, candidates, users, admins, creators, partyAgents } from "./schema";
...
export const expThesesTranslationRelations = relations(expThesesTranslation, ({ one }) => ({
...
export const statementTranslationsRelations = relations(statementTranslations, ({ one }) => ({
	instance: one(instances, {
...
export const candidatesLightRelations = relations(candidatesLight, ({ one }) => ({
