...
export const statements = pgTable(
  "statements",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('statements_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
...
export const expThesesTranslation = pgTable(
  "exp_theses_translation",
  {
...
export const expAppTheses = pgTable(
  "exp_app_theses",
  {
    id: serial().primaryKey().notNull(),
    instanceId: serial("instance_id").notNull(),
...
export const statementTranslations = pgTable(
  "statement_translations",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('statement_translations_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
...
export const notifications = pgTable(
  "notifications",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('notifications_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
    title: text().notNull(),
...
export const candidatesLight = pgTable(
  "candidates_light",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('candidates_light_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
...
export const partyVotes = pgTable(
  "party_votes",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('party_votes_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
  ...
  (table) => [
    uniqueIndex("idx_party_vote").using(
      "btree",
      table.statementId.asc().nullsLast().op("int4_ops"),
      table.partyId.asc().nullsLast().op("int4_ops"),
    ),
    foreignKey({
      columns: [table.instanceId],
      foreignColumns: [instances.id],
...
export const candidateVotes = pgTable(
  "candidate_votes",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('candidate_votes_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
    value: integer().notNull(),
  ...
  (table) => [
    uniqueIndex("idx_candidate_vote").using(
      "btree",
      table.statementId.asc().nullsLast().op("int4_ops"),
...
export const parties = pgTable(
  "parties",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('parties_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
...
export const genders = pgTable("genders", {
  id: integer()
    .default(
      sql`bounded_pseudo_encrypt((nextval('genders_id_seq'::regclass))::integer, 16777215, 1000)`,
    )
    .primaryKey()
    .notNull(),
...
export const users = pgTable(
  "users",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('users_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
    title: text().notNull(),
...
export const admins = pgTable(
  "admins",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('admins_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
...
export const elections = pgTable("elections", {
  id: integer()
    .default(
      sql`bounded_pseudo_encrypt((nextval('elections_id_seq'::regclass))::integer, 16777215, 1000)`,
    )
    .primaryKey()
    .notNull(),
...
export const creators = pgTable(
  "creators",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('creators_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
    userId: serial("user_id").notNull(),
...
export const partyAgents = pgTable(
  "party_agents",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('party_agents_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
    userId: serial("user_id").notNull(),
...
export const instances = pgTable(
  "instances",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('instances_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
...
export const candidates = pgTable(
  "candidates",
  {
    id: integer()
      .default(
        sql`bounded_pseudo_encrypt((nextval('candidates_id_seq'::regclass))::integer, 16777215, 1000)`,
      )
      .primaryKey()
      .notNull(),
    userId: serial("user_id").notNull(),
